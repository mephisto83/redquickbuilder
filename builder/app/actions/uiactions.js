...
export function GetSharedComponentFor(viewType, modelProperty, currentNodeId, isPluralComponent) {
...
export function setSharedComponent(args) {
  let { properties, target, source, viewType, uiType, isPluralComponent } = args
