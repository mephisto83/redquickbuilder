...
GridHeaderMainMenuMain.callingArguments = [ 'main', 'mainSection', 'header', 'mainMenu' ].map((v) => ({
	name: v,
	field: v,
	value: v,
	title: v
}));
export default function GridHeaderMainMenuMain(args: any = {}) {
						...
						value: {
							...
							properties: {
								...
								[context.node5]: {
									...
									children:
										context.main || context.mainSection
											? {
