...
export default function AddRegistrationValidation(args: any = {}) {
											...
											[context.node3]: {
												validators: {
													[context.node4]: {
														...
														templatejs:
															'./app/templates/validation/validation_generic_js.tpl',
														arguments: {
															value: {
																type: 'STRING',
											...
											[context.node14]: {
												validators: {
													...
													[context.node17]: {
														...
														templatejs:
															'./app/templates/filter/equals-model-property_js.tpl',
														arguments: {
															value: {
																type: 'STRING',
																nodeType: 'model-property'
