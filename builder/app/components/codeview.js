...
class CodeView extends Component {
  ...
  render() {
    ...
    let server_side_setup = graphRoot
      ? graphRoot[GraphKeys.SERVER_SIDE_SETUP]
      : null;
              ...
              <Box primary={true} title={Titles.CodeTypes}>
                <ButtonList
                  ...
                  isSelected={item => {
                    return (
                      item &&
                      this.state[UIA.Visual(state, CODE_VIEW_TAB)] === item.id
                    );
                  }}
                  items={models}
                  onClick={item => {
                  ...
                  {code_types
                    ? code_types.map(ct => {
                        return (
                          <Tab
                            key={ct}
                            active={UIA.VisualEq(state, CODE_VIEW_TAB, ct)}
                            title={ct}
                            onClick={() => {
