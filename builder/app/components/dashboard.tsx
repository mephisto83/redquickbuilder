		...
		if (UIA.Visual(state, UIA.SELECTED_NODE)) {
			...
			switch (nodeType) {
					...
					result.push({
						onClick: () => {
							this.props.setVisual(CONNECTING_NODE, {
								...
								nodeTypes: [NodeTypes.Method, NodeTypes.Function]
							});
						},
						icon: 'fa  fa-music',
				...
				case NodeTypes.ComponentExternalApi:
					...
					return result;
				case NodeTypes.FunctionOutput:
					result.push({
						onClick: () => {
							this.props.setVisual(CONNECTING_NODE, {
								...LinkProperties.FunctionOutputType,
								singleLink: true,
								nodeTypes: [NodeTypes.Model, NodeTypes.Enumeration, NodeTypes.Attribute]
							});
						},
						icon: 'fa fa-share-alt',
						title: Titles.ConnectType
					})
					break;
				...
				<div className="wrapper" style={{ height: '100vh' }}>
					...
					<div data-tid="container">
						...
						>
							...
							{UIA.VisualEq(state, SELECTED_TAB, QUICK_MENU) ? <CheckRelationships /> : null}
