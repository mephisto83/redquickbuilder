      ...
      <TabPane active={active}>
          ...
          <SelectInput
            ...
            value={
              currentNode.properties
                ? currentNode.properties[UIA.NodeProperties.FunctionType]
                : ""
            }
          />
        ) : null}
        ...
        {currentNode ? (
          <SelectInput
            ...
            value={UIA.GetNodeProp(currentNode, NodeProperties.HttpMethod)}
          />
        ) : null}
        {currentNode ? (
          <TextInput
        ...
        {currentNode ? (
          <CheckBox
            ...
            value={UIA.GetNodeProp(
              currentNode,
              UIA.NodeProperties.NotIncludedInController
            )}
          />
        ) : null}
        {currentNode ? (
          <CheckBox
            ...
            value={UIA.GetNodeProp(currentNode, UIA.NodeProperties.AsForm)}
          />
        ) : null}
        {currentNode &&
        UIA.GetNodeProp(currentNode, UIA.NodeProperties.AsForm) ? (
          <CheckBox
            ...
            value={UIA.GetNodeProp(
              currentNode,
              UIA.NodeProperties.CollectCookies
            )}
          />
        ) : null}
        {currentNode ? (
          <CheckBox
            ...
            value={UIA.GetNodeProp(currentNode, UIA.NodeProperties.AsText)}
          />
        ) : null}
        {currentNode ? (
          <CheckBox
            ...
            value={UIA.GetNodeProp(currentNode, UIA.NodeProperties.NoApiPrefix)}
          />
        ) : null}
        <ControlSideBarMenu>
          {currentNode &&
            ...
            <ControlSideBarMenuItem
              onClick={() => {
                this.props.graphOperation([
                  { operation: UIA.ESTABLISH_SCOPE },
                  { options: { id: currentNode.id } }
                ]);
              }}
              icon={"fa fa-puzzle-piece"}
              title={Titles.CustomFunction}
              description={Titles.CustomFunctionDescription}
            />
          ) : null}
          {currentNode ? (
            <ControlSideBarMenuItem
              ...
              description={Titles.AddModelItemFilterDescription}
            />
          ) : null}
          {currentNode ? (
            <ControlSideBarMenuItem
              onClick={() => {
                this.props.graphOperation(UIA.NEW_AFTER_METHOD, {
                  ...
                  properties: {
                    [NodeProperties.UIText]: `${UIA.GetNodeProp(
                      currentNode,
              ...
              description={Titles.AddAfterMethodsDescription}
            />
          ) : null}
        </ControlSideBarMenu>
      </TabPane>
