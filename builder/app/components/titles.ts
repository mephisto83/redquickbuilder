...
export const ANDNode = 'And';
export const GetSelf = 'Get Self';
export const OrNode = 'Or';
export const BatchMenu = 'Batch Menu';
export const StaticParamter = 'Static Parameter';
export const BuildDefault = 'Build Default';
export const StaticParameters = 'Static Parameteres';
export const PermissionEnums = 'Permission Enums';
export const PermissionSource = 'Permission Source';
export const Create_Parent_Child_Agent_Value__Child = 'Create Parent/Child with Agent';
...
export const ScreenEffects = 'Screen Effects';
export const AddScreenEffect = 'Add Screen Effect';
export const BuildMenus = 'Build Menus';
...
export const RedQuickConfigurations = 'Red Quick Configurations';
export const CommandCenters = 'Command Centers';
...
export const ComponentTag = 'Component Tag';
...
export const GridTemplateRows = 'Grid Template Rows';
export const GridPlacement = 'Grid Placement';
export const GridColumnGap = 'Grid Column Gap';
export const GridRowGap = 'Grid Row Gap';
export const GridTemplateColumns = 'Grid Template Columns';
export const Fonts = 'Fonts';
export const SpaceTheme = 'Space Theme';
export const LinkProperties = 'Link Properties';
export const OtherUses = 'CSS Variables';
export const ColorUse = 'Color Use';
export const BindAll = 'Bind All';
export const UseHttps = 'Use Https';
export const Parameter = 'Parameter';
export const SelectTargetScreen = '[Select Target Screen]';
...
export const UIAgnostic = 'UI Agnostic';
...
export const FontSource = 'Font Source';
export const FontSize = 'Font Size';
export const Color = 'Color';
export const FontWeight = 'Font Weight';
export const ConnectType = 'Connect Type';
...
export const DeepDownTree = 'Pass Down Tree';
...
export const FromProperty = 'From property';
...
export const ModelOutput = 'Model Output';
...
export const CopyContexts = 'Copy Contexts';
...
export const ConnectToDataChainResponseHandler = 'Connect to DataChain response handler';
export const ConnectToDataChainPrecallHandler = 'Connect to DataChain precall handler';
...
export const ParameterValueA = 'Parameter Value A';
export const ParameterValueB = 'Parameter Value B';
...
export const CopyNodeConnectionInfoToClip = 'Copy Node Connection into to clip';
export const AgentOperator = 'Agent Operator';
export const Enumerable = 'Enumerable';
export const JobConfigs = 'Job Configs';
...
export const SwaggerApiPath = 'Swagger Api Path';
export const SwaggerApiDescription = 'Swagger Api Description';
export const QuickColor = 'Quick Color';
export const MainNavigation = 'Main Navigation';
export const SwaggerCall = 'Swagger Call';
...
export const SetInteger = 'Set Integer';
export const Delete = 'Delete';
export const IncrementInteger = 'Increment Integer';
export const Concatenate = 'Concatenate String';
export const ConcatenateCollection = 'Concatenate Collection';
export const SetBoolean = 'Set boolean';
export const Routing = 'Routing';
export const IsNotDeleted = 'Is Not Deleted';
export const DirectType = 'Direct type';
...
export const AlphaOnyl = 'Alpha only';
export const CreditCard = 'Credit Card';
export const Email = 'Email';
export const EmailEmpty = 'Email empty';
export const NumericInteger = 'Numeric integer';
export const RequireLowercase = 'Require lowercase';
export const RequireNonAlphaNumeric = 'Require non alphanumeric';
export const RequireUppercase = 'Require Uppercase';
export const SocialSecurity = 'SocialSecurity';
export const AlphaOnly = 'Alpha only';
export const AlphaNumeric = 'Alpha numeric';
export const Url = 'Url';
export const UrlEmpty = 'Url empty';
export const Zip = 'Zip';
export const ZipEmpty = 'Zip empty';
export const ChoiceListActions = 'Choice Actions';
export const IfTrue = 'If true';
export const IfFalse = 'If false';
...
export const IgnoreModels = 'Ignore Models';
export const IgnoreAgents = 'Ignore Agents';
export const CopyEnumeration = 'Copy Enumeration';
...
export const Get_Default_Object_For_Agent_With_Parent = 'Get Default Object With Parent For Agent';
export const Get_Default_Object_For_Agent_With_ParentandAgent = 'Get Default Object with Parent and Agent ref';
...
export const ChangeUserPassword = 'Change User Password';
export const AsPlural = 'As Plural';
export const AddFunction = 'Add function';
export const ForgotLogin = 'Forgot Login';
...
export const AddFunctionParameter = 'Add function parameter';
...
export const UseModelAsLocal = 'Use Model as Local';
...
export const RelationType = 'Relation Type';
export const CheckExistence = 'Check for existence';
export const AddNewSection = 'Add New Section';
export const Sections = 'Sections';
export const Executions = 'Executions';
export const Validations = 'Validations';
export const ReturnSetting = 'Return settings';
...
export const MinLength = 'Min length';
export const Execution = 'Execution';
export const IsNotNull = 'Is not null';
export const AlphaOnlyWithSpaces = 'Alpha only with spaces';
...
export const SetPropertiesConfig = 'Set Properties Config';
