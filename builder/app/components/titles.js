...
export const CopyExecution = "Copy Execution";
...
export const UseInstanceType = "Use Instance Type";
...
export const SelectedShortCut = "Ctrl + q";
export const ColorScheme = "Color Scheme";
export const EnableMenu = "Enable Menu";
export const ExternalApi = "External Api";
export const InternalApi = "Internal Api";
...
export const MediaQuery = "Media Query";
...
export const UseValue = "Use Value";
...
export const SetDefaultPropertiesDescription =
  "Set default properties, on the node";
...
export const NavigateBack = "Navigate Back";
export const ConnectEventHandler = "Connect Event Handler";
...
export const DataChainCollection = "Data Chain Collection";
...
export const AddAfterMethodsDescription =
...
export const OwnedResourcesDescription =
  "Check if permissions are for resources owned by source model.";
...
export const AddPermissionDescription =
  "Permission nodes describe the ability of connected models on downstream models";
...
export const EnterName = "Enter Name";
...
export const AddExtensionListDescription =
  "Extension list customize dropdowns/lists.";
...
export const IsHandler = "Is handler";
export const InstanceType = "Instance Type";
export const Input = "Input";
export const Screen = "Screen";
export const SelectorProperty = "Selector Property";
export const NavigationAction = "Navigation Action";
...
export const AddSelector = "Add Selector";
...
export const DependsOnDescription =
  "Defines if a the property associated with this extension is visually dependent on the value of another property on the same object.";
export const DependentPropertyDescription =
  "The property that the current property will be associated.";
export const MatchingValue = "Matching Value";
export const MatchingValueDescription =
  "The value that the associated property will have to equal, to enable the current property";
...
export const GetObjectsFromLIstOfIds = "Fetch Service compatible function";
export const AddAllProperties = "Add all properties";
export const ApplyCopyToAllProperties = `Apply 'copy' to all properties`;

export const Get_ManyToMany_Agent_Value__IListChild =
  "Get Many to Many => IList<Child>";
export const Create_ManyToMany_Agent_Value__IListChild =
  "Create Many to Many => IList<Child>";
export const Update_ManyToMany_Agent_Value__IListChild =
  "Update Many to Many => IList<Child>";
export const Delete_ManyToMany_Agent_Value__IListChild =
  "Delete Many to Many => IList<Child>";

export const Create_Parent$Child_Agent_Value__IListChild =
  "Create Parent/Child => IList<Child>";
export const Update_Parent$Child_Agent_Value__IListChild =
...
export const Update_Object_Agent_Value__IListObject =
  "Update Object by Agent => IList<Object>";
export const Delete_Object_Agent_Value__IListObject =
  "Delete Object by Agent => IList<Object>";
export const Get_Object_Agent_Value__IListObject =
  "Get Object by Agent => IList<Object>";
...
export const SelectViewPackage = "Select View Package";
export const PinSelected = "Pin Selected";
export const UnPinSelected = "Unpin Selected";
export const ClearMarked = "Clear Marked";
export const Clear = "Clear";
export const AddDataChainCollection = "Add Data Chain Collection Parent";
...
export const HasLogicalChildrenDescription =
  "Children have references to this node, as some sort of logical parent.";
export const HasLogicalNieces = "Has logical nieces";
export const HasLogicalNiecesDescription =
  "Children have references to this node and others potentially as some sort of logical uncle/aunt. This is for many to many relationships.";
export const UseModelAsType = "Use Model as Type";
export const CustomFunction = "Custom Function";
export const CustomFunctionDescription =
  "Function can be constructed in an internal graph.";
