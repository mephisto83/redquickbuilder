    ...
    if (prop_obj && prop_obj.nodeProperty) {
      ...
      if (componentApi) {
        ...
        return [
          ...
          .subset(
            0,
            UIA.Visual(this.props.state, "apiProperty-title" + apiProperty)
              ? 1000
              : 1
          )
          .filter(x => x);
              ...
              onClick={() => {
                this.props.graphOperation(UIA.NEW_DATA_SOURCE, {
                  ...
                  properties: {
                    ...
                    [UIA.NodeProperties.UIText]: `${UIA.GetNodeTitle(
                      currentNode
                    )} Data Source`
                  },
                  linkProperties: {
