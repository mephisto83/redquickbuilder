...
import { NodeProperties, NodeTypes, LinkEvents, LinkType, ExecutorRules, ExecutorUI } from '../constants/nodetypes';
            ...
            <TabPane active={active} >
                {currentNode ? (<FormControl>
                    <div className="btn-group">
                        <button onClick={() => {
                            addProperty(propertyNodes.map(t => {
                                return (t.value);
                            }));

                        }} type="button" title={Titles.AddAllProperties} className="btn btn-default btn-flat"><i className="fa fa-align-left"></i></button>
                        <button onClick={() => {
                        ...
                        }} type="button" title={Titles.ApplyCopyToAllProperties} className="btn btn-default btn-flat"><i className="fa fa-align-center"></i></button>
                    </div>
                    <SelectInput
