...
export default class PhoneNumberInput extends React.Component<any, any> {
    ...
    render() {
        ...
        let options = ['Cell', 'Home', 'Work', 'Other'];
        return (
            <View {...props}>
                <Dropdown
                    value={this.state.phoneNumber.phoneNumberType}
                    options={options.map((t: string) => ({ title: t, value: t }))}
