...
export function UISMIO(form: string, model: any, instance: any, value: any) {
	return {
...
export function Batch(
	a?: { type: string; key: string; form: any; model: any; instance?: any; item?: any; value: any },
	b?: any,
	c?: any,
	d?: any,
	e?: any,
...
export function Visual(state: any, key: string | number) {
...
export function GetC(state: { uiReducer: { [x: string]: { [x: string]: any } } }, key: string, id: string) {
	if (state) {
...
export function GetK(
	state: { uiReducer: { [x: string]: { [x: string]: { [x: string]: any } } } },
	key: string,
	id: string,
...
export function Get(state: { uiReducer: { [x: string]: any } }, key: string) {
	if (state) if (state.uiReducer[key]) return state.uiReducer[key];
	return null;
}

let _navigation: {
	navigate: (arg0: any, arg1: any, arg2: any) => any;
	getParam: (arg0: any, arg1: any) => any;
} | null = null;
...
export function GetScreenInstance(key: string | number, id: string | number) {
	if (_getState) {
		let state = _getState();
...
export function GetModelInstance(key: string | number, instance: string | number, id: string | number) {
	if (_getState) {
		let state = _getState();
		let modelInstance = GetModelInst(state, instance, id);
...
export function GetScreenModelInst(state: any, instance: any, id: string | number) {
...
export function GetScreenModelDirtyInst(state: any, instance: any, id: string | number) {
...
export function GetScreenModelFocusedInst(state: any, instance: any, id: string | number) {
...
export function GetScreenModelBlurInst(state: any, instance: any, id: string | number) {
...
export function GetScreenModelFocusInst(state: any, instance: any, id: string | number) {
...
export function GetScreenInstanceBlur(key: string | number, id: string | number) {
	if (_getState) {
		let state = _getState();
...
export function GetModelInstanceBlur(key: string | number, instance: any, id: string | number) {
	if (_getState) {
		let state = _getState();
...
export function GetScreenInstanceBlurObject(key: string | number) {
	if (_getState) {
		let state = _getState();
		let screenInstance = GetScreenInstBlur(state);
...
export function GetModelInstanceBlurObject(key: string | number, instance: any) {
	if (_getState) {
		let state = _getState();
		let modelInstance = GetModelInstBlur(state, instance);
...
export function GetScreenInstanceFocus(key: string | number, id: string | number) {
	if (_getState) {
		let state = _getState();
...
export function GetModelInstanceFocus(key: string | number, instance: any, id: string | number) {
	if (_getState) {
		let state = _getState();
...
export function GetScreenInstanceFocusObject(key: string | number) {
	if (_getState) {
		let state = _getState();
		let screenInstance = GetScreenInstFocus(state);
...
export function GetModelInstanceFocusObject(key: string | number, instance: any) {
	if (_getState) {
		let state = _getState();
		let modelInstance = GetModelInstFocus(state, instance);
...
export function GetScreenInstanceDirty(key: string | number, id: string | number) {
	if (_getState) {
		let state = _getState();
...
export function GetModelInstanceDirty(key: string | number, instance: any, id: string | number) {
	if (_getState) {
		let state = _getState();
...
export function GetScreenInstanceDirtyObject(key: string | number) {
	if (_getState) {
		let state = _getState();
		let screenInstance = GetScreenInstDirty(state);
...
export function GetModelInstanceDirtyObject(key: string | number, instance: any) {
	if (_getState) {
		let state = _getState();
		let modelInstance = GetModelInstDirty(state, instance);
...
export function GetScreenInstanceFocused(key: string | number, id: string | number) {
	if (_getState) {
		let state = _getState();
...
export function GetModelInstanceFocused(key: string | number, instance: any, id: string | number) {
	if (_getState) {
		let state = _getState();
...
export function GetScreenInstanceFocusedObject(key: string | number) {
	if (_getState) {
		let state = _getState();
		let screenInstance = GetScreenInstFocused(state);
...
export function GetModelInstanceFocusedObject(key: string | number, instance: any) {
	if (_getState) {
		let state = _getState();
		let modelInstance = GetModelInstFocused(state, instance);
...
export function GetScreenInstanceObject(key: string | number) {
	if (_getState) {
		let state = _getState();
		let screenInstance = GetScreenInst(state);
		if (screenInstance) {
...
export function GetAppStateObject(key: string | number) {
	if (_getState) {
		let state = _getState();
...
export function updateScreenInstance(model: any, id: any, value: any, options = { update: false, value: null }) {
	return (dispatch: (arg0: { type: string; batch: any[] }) => void, getState: any) => {
...
export function clearScreenInstance(model: any, id: any, options = { update: false, value: null }) {
	return (dispatch: (arg0: { type: string; batch: any[] }) => void, getState: any) => {
		if (options && options.update) {
			dispatch(
				Batch(
...
export function updateScreenInstanceBlur(model: any, id: any, options = { update: false, value: null }) {
	return (dispatch: (arg0: { type: string; batch: any[] }) => void, getState: any) => {
		if (options && options.update) {
			dispatch(
				Batch(
...
export function updateScreenInstanceFocus(model: any, id: any, options = { update: false, value: null }) {
	return (dispatch: (arg0: { type: string; batch: any[] }) => void, getState: any) => {
		if (options && options.update) {
			dispatch(
				Batch(
